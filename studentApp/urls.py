...
from student_app import views  # Import the register view from student_app
...
urlpatterns = [
    ...
    path('accounts/logout/', auth_views.LogoutView.as_view(), name='logout'),  # For logout functionality
    path('accounts/register/', views.register, name='register'),  # For user registration
    # Makes student list the homepage
